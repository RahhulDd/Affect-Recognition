# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 09:37:20 2020
...
class _DatasetForSkeleton(_DatasetBase):
    def __init__(self, phase, config):
        super(_DatasetForSkeleton, self).__init__(phase, config)
...
class _DatasetForView(_DatasetBase):
    def __init__(self, phase, config):
        super(_DatasetForView, self).__init__(phase, config)
...
class _DatasetForFull(_DatasetBase):
    def __init__(self, phase, config):
        super(_DatasetForFull, self).__init__(phase, config)
